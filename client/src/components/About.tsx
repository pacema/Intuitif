export default function About() {
  return (
    <section id="about" className="py-24 md:py-32" style={{ backgroundColor: '#296887' }}>
      <div className="max-w-4xl mx-auto px-6">
        <div className="space-y-8">
          ...
          <blockquote className="font-serif italic text-xl md:text-2xl text-center text-white/95 pt-8">
